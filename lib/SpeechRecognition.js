...
var useSpeechRecognition = function useSpeechRecognition() {
  ...
  var _useReducer = (0, _react.useReducer)(_reducers.transcriptReducer, {
    ...
    finalTranscriptAlternatives: []
      ...
      finalTranscriptAlternatives = _useReducer2$.finalTranscriptAlternatives,
  ...
  var handleTranscriptChange = (0, _react.useCallback)(function (newInterimTranscript, newFinalTranscript, newFinalTranscriptAlternatives) {
    if (transcribing) {
      dispatch((0, _actions.appendTrancript)(newInterimTranscript, newFinalTranscript, newFinalTranscriptAlternatives));
    }
  ...
  return {
    ...
    finalTranscriptAlternatives: finalTranscriptAlternatives,
    listening: listening,
